"""
This file provides trainer for Mixture of Experts.
This needs a pretrained AVOD model. The weights of AVOD are kept as it is.
Only MoE is trained.
This file is built upon the original trainer file - trainer.py
"""
import datetime
import os
...
def train(model, train_config):
    ...
    for step in range(global_step, max_iterations + 1):
        ...
        #######################################################################################
        # Output weights for img and bev
