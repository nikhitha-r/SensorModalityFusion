...
_MODELCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='moe_config', full_name='avod.protos.ModelConfig.moe_config', index=13,
...
_MODELCONFIG.fields_by_name['moe_config'].message_type = _MOECONFIG
...
MoeConfig = _reflection.GeneratedProtocolMessageType('MoeConfig', (_message.Message,), dict(
